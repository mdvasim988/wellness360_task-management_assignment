...
1. **Clone the repository:**
   ...
   cd wellness360_task-management_assignment
   ```
2. **Open in your IDE:**
...
3. **Run the Application:**
    ...
    * Navigate to `src/test/java/com/assignment/wellness360/task_management_system/service/impl/TaskServiceImplTest.java`
    * Right-click and Run to perform unit testing.
...
3. While creating task, we don't need to provide the `id` for the task as it is autogenerated by the database. I also considered that generally we as a user doesn't provide `id` for the tasks.

---

## Note

1. Postman collection is attached to test the endpoints.
